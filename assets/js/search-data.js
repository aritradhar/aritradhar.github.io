...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "news-our-paper-guardain-protecting-emerging-generative-ai-workloads-on-heterogeneous-npu-internally-known-as-ascend-cc-has-been-accepted-for-publication-at-ieee-security-and-privacy-s-amp-amp-p-2025",
          title: 'Our paper, ‘GuardAIn: Protecting Emerging Generative AI Workloads on Heterogeneous NPU’ (internally known...',
          description: "",
          section: "News",},{id: "news-our-paper-ac-lora-almost-training-free-access-control-aware-multi-modal-llms-has-been-accepted-for-publication-at-neurips-2025",
          title: 'Our paper, ‘AC-LoRA: (Almost) Training-Free Access Control-Aware Multi-Modal LLMs’, has been accepted for...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=Icgn4goAAAAJ", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.aritradh.com/", "_blank");
        },
      },{
      id: 'light-theme',
